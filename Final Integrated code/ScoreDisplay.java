...
public class ScoreDisplay extends Actor
{
    ...
    public void updateDisplay(Objects obj)
    {
        ...
        else if(obj.getClass().getName() == "Enemy")
        {
            ...
            imagE = new GreenfootImage("Enemy.png");
        }
        scoredisplay.clear();
        setImage("yellow.png");
        display(score, imagE, name);    
